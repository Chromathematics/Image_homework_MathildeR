...
dataframe =  pandas.read_excel(r"C://Users//rouxm//Desktop//2025-2026 - ARIA//Image//Homework//epsilon_FGSM_trained.xlsx", header=0)
...
dataframe.to_excel("epsilon_FGSM_trained.xlsx", header=True,float_format="%.12f",index=False)
